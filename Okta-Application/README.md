...
1. Write the JSON schema describing your resource, [okta-application-application.json](./okta-application-application.json)
2. Implement your resource handlers in [handlers.ts](./okta-application-application/handlers.ts)

> Don't modify [models.ts](./okta-application-application/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
