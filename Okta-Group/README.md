...
1. Write the JSON schema describing your resource, [okta-group-group.json](./okta-group-group.json)
2. Implement your resource handlers in [handlers.ts](./okta-group-group/handlers.ts)

> Don't modify [models.ts](./okta-group-group/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
