...
1. Write the JSON schema describing your resource, [okta-policy-policy.json](./okta-policy-policy.json)
2. Implement your resource handlers in [handlers.ts](./okta-policy-policy/handlers.ts)

> Don't modify [models.ts](./okta-policy-policy/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
