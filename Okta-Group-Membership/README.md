...
1. Write the JSON schema describing your resource, [okta-group-membership.json](./okta-group-membership.json)
2. Implement your resource handlers in [handlers.ts](./okta-group-membership/handlers.ts)

> Don't modify [models.ts](./okta-group-membership/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
