...
1. Write the JSON schema describing your resource, [okta-group-groupapplicationassociation.json](./okta-group-groupapplicationassociation.json)
2. Implement your resource handlers in [handlers.ts](./okta-group-groupapplicationassociation/handlers.ts)

> Don't modify [models.ts](./okta-group-groupapplicationassociation/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
